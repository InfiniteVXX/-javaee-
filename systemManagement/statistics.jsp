...
<%
    ...
    for (int i = 0; i < allOrders.size(); i++) {
        if (allOrders.get(i).getOrderStatus().equals("已开工")) {
            checkInOrderNumber++;
        } else if (allOrders.get(i).getOrderStatus().equals("已验收")) {
            checkOutOrderNumber++;
...
//--------------酒店不同房型订房数量时间线------------------ //
    ...
    weekRoomType.add("冶金项目");
    weekRoomType.add("加工项目");
    weekRoomType.add("化工项目");
    weekRoomType.add("环境项目");
    weekRoomType.add("矿业项目");
