            ...
            <div class="eleven wide  column" >
                ...
                <div class="ui three column grid" >
                    ...
                    <form class="ui form" onsubmit="return  fun4(this)" >
                        <h4 class="ui dividing header">项目选择</h4>
                        <div class="field">
                            <label>编号</label>
                        ...
                        <h4 class="ui dividing header">项目周期</h4>
                        <div class="field">
                            <label>时间</label>
                            <div class="two fields">
                                <div class="field">
                                    <input type="text" maxlength="5" id="time" name="time" placeholder="项目周期">

                                </div>
                            </div>
                        </div>
                        <h4 class="ui dividing header">总工信息</h4>
                        <div class="field">
                            <label>姓名</label>
                            <div class="two fields">
                    ...
                    <div class="ui right floated labeled button" tabindex="0">
                        ...
                        <div class="ui right button">
                            <i class="shopping icon"></i> <a href="ServiceManage?<%=request.getQueryString()%>">结算</a>
                        </div>
                    </div>
                    <%} else if (op == 4) {%>
                    <h4 class="ui dividing header">结算成功</h4>
