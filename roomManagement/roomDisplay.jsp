        ...
        <div class="ui column grid">
            ...
            <div class="eleven wide  column" >
                <div class="ui search ">
                    ...
                    <div class="ui button" onclick="fun2()"> <i class="search icon"></i>项目编号检索</div>
                </div>
                ...
                <div class="ui three cards" >
                    ...
                    <div class="card" >
                        ...
                        <div class="extra">
                            序号:<%=roominfo.getRoomNumber()%><br>
                            类型:<%=roominfo.getRoomType()%><br>
                            <% if(roominfo.getRoomStatus().equals("非空")){
                                OrderView view = Query.getFullOrderViews(roominfo.getRoomNumber());
                            %>
                            总工:<%=view.getCustomer()%><br>
                            结束时间:<%=view.getCheckOutTime()%><br>
                            <%} %>
                        </div>
                    </div>
                    <%}%>
