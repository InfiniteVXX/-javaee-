        ...
        <div class="ui column grid">
            ...
            <div class="eleven wide  column" >
                ...
                <form class="ui form" onsubmit="return submitNewRoomInfo(this)">
                    <h2 class="ui dividing header">填写新增项目信息</h2>
                    <div class="two fields">
                        <div class="field">
                            <label>项目编号</label>
                            <input type="text" id="roomNumber" name="roomid" placeholder="输入编号">
                        </div>
                        <div class="field">
                            <label>项目类型</label>
                ...
                <h2 class="ui dividing header">待添加项目信息确认</h2>
                <form class="ui form">
                    <table class="ui table">
                        <thead>
                        <tr><th class="six wide">项目编号</th>
                            <th class="six wide">项目类型</th>
