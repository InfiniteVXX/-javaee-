...
<div class="pusher">
    <div class="ui  inverted menu">
        ...
        <div class="ui simple dropdown item">
            <i class="users icon"></i>人事管理
            <i class="dropdown icon"></i>
            <div class="menu">
                <a class="item" href="/AdministrationManage?mop=4"><i class="add user icon"></i>新增项目经理</a>
                <a class="item" href="/AdministrationManage?mop=5"><i class="edit icon"></i>编辑项目经理</a>
            </div>
        </div>
        ...
        <div class="right menu">
            <div class="ui simple dropdown item">
                <i class="user icon"></i>
                <%="人事经理: " + session.getAttribute("systemadmin")%>
