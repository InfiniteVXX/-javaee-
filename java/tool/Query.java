...
//            preparedStatement = connection.prepareStatement();
    ...
    public static void checkOutRoom(String orderNumber){
        ...
        try {
            connection =  DataBase.getConnection();
            String sql ="update orders set orderStatus='已验收' where orderNumber='"+orderNumber+"'" ;
            preparedStatement = connection.prepareStatement(sql);
            preparedStatement.execute();
        } catch(Exception exception) {
            exception.printStackTrace();
    ...
    public static Order getOrder(String roomid){
        ...
        try {
            connection =  DataBase.getConnection();
            String sql ="select * from orders where roomNumber='"+roomid+"' and orderStatus='已开工'" ;
            preparedStatement = connection.prepareStatement(sql);
            resultSet = preparedStatement.executeQuery();
            if(resultSet.next()){
    ...
    public static double searchDiscount(String id ){
        ...
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        int level =searchVIPlevel(id) ; //该总工的等级
        try {
            connection =  DataBase.getConnection();
    ...
    //查询延期项目(timeextension tt, orders od, customers ct)
